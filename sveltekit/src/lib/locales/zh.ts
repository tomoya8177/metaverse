export default {
	...
	'Left Early': '早退',
	Comment: '评论',
	'Sent an invitation to ': '已向以下用户发送邀请：',
	Deleted: '已删除',
	'Are you sure?': '您确定吗？',
	OK: '确定',
	Cancel: '取消',
	'Sent invitations to users.': '已向用户发送邀请。',
	Created: '已创建',
	'Please click the link below to checkout the organization page!':
		'请点击下面的链接查看组织页面！',
	"You've just joined the organization: ": '您刚刚加入了组织：',
	'Notification from VirtuaCampus': '来自VirtuaCampus的通知',
	'AI is generating the content...': 'AI正在生成内容...',
	'AI completed to generate the image for you. @': 'AI已为您生成图像。@',
	Object: '对象',
	'Locked Position': '锁定位置',
	'Link to Room/Mentor': '链接到房间/导师',
	'Attach Event': '附加事件',
	'Attach Caption': '附加说明',
	Event: '事件',
	'Graphics Preview': '图形预览',
	'Clear Graphic': '清除图形',
	'Upload Graphic': '上传图形',
	'Generate Graphic with AI': '使用AI生成图形',
	'Sample Title': '示例标题',
	'"Click to open" message will be displayed after one click on the object.':
		'单击对象后将显示“单击以打开”消息。',
	'Add Text Card': '添加文本卡片',
	'Graphic Colors': '图形颜色',
	'Please read our Terms of Service and Privacy Policy before using this service.':
		'在使用本服务之前，请阅读我们的服务条款和隐私政策。',
	'Terms of Service': '服务条款',
	'Privacy Policy': '隐私政策',
	'Edit Profile': '编辑个人资料',
	Status: '状态',
	Bio: '个人简介',
	'has joined the room!': '已加入房间！',
	'left the room': '已离开房间'
};
