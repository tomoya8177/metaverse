export default {
	...
	Present: '출석',
	Absent: '결석',
	'Invitation Sent': '초대장이 전송되었습니다',
	Late: '지각',
	Excused: '사유 있음',
	'Left Early': '일찍 떠남',
	Comment: '의견',
	'Sent an invitation to ': '다음 사용자에게 초대장을 보냈습니다: ',
	Deleted: '삭제되었습니다',
	'Are you sure?': '확실합니까?',
	OK: '확인',
	Cancel: '취소',
	'Sent invitations to users.': '사용자에게 초대장을 보냈습니다.',
	Created: '생성되었습니다',
	'Please click the link below to checkout the organization page!':
		'조직 페이지를 확인하려면 아래 링크를 클릭하세요!',
	"You've just joined the organization: ": '조직에 가입했습니다: ',
	'Notification from VirtuaCampus': 'VirtuaCampus로부터 알림',
	'AI is generating the content...': 'AI가 콘텐츠를 생성 중입니다...',
	'AI completed to generate the image for you. @': 'AI가 이미지를 생성했습니다. @',
	Object: '객체',
	'Locked Position': '고정된 위치',
	'Link to Room/Mentor': '방/멘토로의 링크',
	'Attach Event': '이벤트 첨부',
	'Attach Caption': '캡션 첨부',
	Event: '이벤트',
	'Graphics Preview': '그래픽 미리보기',
	'Clear Graphic': '그래픽 지우기',
	'Upload Graphic': '그래픽 업로드',
	'Generate Graphic with AI': 'AI로 그래픽 생성',
	'Sample Title': '샘플 제목',
	'"Click to open" message will be displayed after one click on the object.':
		'한 번의 클릭으로 "열기" 메시지가 표시됩니다.',
	'Add Text Card': '텍스트 카드 추가',
	'Graphic Colors': '그래픽 색상',
	'Please read our Terms of Service and Privacy Policy before using this service.':
		'이 서비스를 사용하기 전에 이용 약관과 개인 정보 보호 정책을 읽어주세요.',
	'Terms of Service': '이용 약관',
	'Privacy Policy': '개인 정보 보호 정책',
	'Edit Profile': '프로필 수정',
	Status: '상태',
	Bio: '소개',
	'has joined the room!': '님이 방에 참여했습니다!',
	'left the room': '님이 방을 나갔습니다'
};
